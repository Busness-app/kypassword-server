...
and downloading need a session signed in within the last 10 minutes; a stale admin is sent
...
redirects, and refuses private, loopback and reserved addresses. A KyRecovery on your own LAN
behind a TLS proxy needs its name to resolve inside the container: put the resolver in
