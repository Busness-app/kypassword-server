...
1. Go to the [Security Advisories](https://github.com/Busness-app/kypassword-server/security/advisories) page
...
- **Vulnerability reports:** [GitHub Security Advisories](https://github.com/Busness-app/kypassword-server/security/advisories)
