...
4. **Bounded Version History & Rollback**: Keep up to 100 recent snapshots per user, with a default 90-day age limit and one-click rollback. Saves and rollbacks prune synchronously under the store lock.
